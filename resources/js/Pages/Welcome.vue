...
<!--                    </div>-->
            ...
            <div class=" flex justify-center items-start  xl:items-center min-h-hero">
                <h1 class="my-8 p-5 sm:pl-[5%] sm:text-2xl mr-auto xl:my-14  xl:mr-[5%] xl:ml-auto text-[burlywood] xl:text-right text-left rounded-xl text-xl backdrop-blur backdrop-opacity-60">
